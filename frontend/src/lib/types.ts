...
export interface RankingEntry {
  id: string; name: string; issuer: string; network: string; color: string;
  region: string | null; timezone: string; different_timezone: boolean; different_date: boolean;
  local_today: string; statement_date: string; due_date: string; days: number; longest_days: number;
}
export interface RankingData { account_timezone: string; as_of: string; cards: RankingEntry[] }
